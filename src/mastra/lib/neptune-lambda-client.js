...
export async function createDocumentNode(documentId, metadata) {
    try {
...
export async function createChunkNode(chunkId, documentId, chunkIndex, content, summary, metadata) {
    try {
...
export async function createChunkRelationships(chunkId, relatedChunks) {
    try {
...
export async function queryGraph(query, limit = 10) {
    try {
...
export async function findRelatedChunks(chunkId, maxDepth = 2) {
    try {
